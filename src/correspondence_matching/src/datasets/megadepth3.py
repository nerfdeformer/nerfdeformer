...
def random_func(x, seed):
    ...
    return 17 * x + 37 * x * seed + 29 * x * seed * seed + 59 * x * x * seed * seed * seed
...
class MegaDepthDataset2(Dataset):
    def __init__(self,
        ...
        if "val" in mode:
            self.pair_infos = [self.pair_infos[(1000000007 * x + 10000000009 * x * x)% 1200] for x in range(20)] + [self.pair_infos[(1000000007 * x + 10000000009 * x * x)% (len(self.pair_infos) - 1200) + 1200] for x in range(20, 50)]
